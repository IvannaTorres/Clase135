...
train_data = pd.read_csv("/content/Clase135/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("/content/Clase135/static/assets/model_files/Tweet_Emotion.h5")
